...
TicTacToe.Controllers.controller('view.SearchController',
    ['$scope', '$rootScope', 'constants.Configuration', 'services.SearchService', 'ngAudio',
        function ($scope, $rootScope, configuration, gameService, ngAudio) {
            ...
            var updateTicTacToeGraphics = function() {
                ...
                if (state.winner != ' ') {
                    ...
                    yourPlayerIndex == winnerPlayerId ? $scope.displayText = "Player "+ yourPlayerIndex +" won the game!" : "";
                    yourPlayerIndex == winnerPlayerId ? "" : $scope.displayText = "Player "+ yourPlayerIndex +" lost the game.";
                } else if (isMyMove()) {
                    $scope.displayText = "Move of Player "+yourPlayerIndex;
                } else {
