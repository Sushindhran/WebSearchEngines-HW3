...
public abstract class Indexer {
     ...
     */
    public abstract Document nextDoc(Query query, int docid) throws IOException, ClassNotFoundException;
    ...
    public abstract String[] getSuggestions(String prefix, String location);
    /**
